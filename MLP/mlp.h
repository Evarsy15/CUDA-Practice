...
public:
    ...
    static void match_single(double *res, double *ans, int output_size, int &val);                 // Single match
    static void match(double *res, vector<double*> &ans, int num_data, int output_size, int &val); // Multiple match
...
protected:
    ...
    vector<double*> b; // Bias of Perceptron Layer
